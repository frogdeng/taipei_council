...
function filterCondition() {
    $(".submitBtn, #date-filter").click(function() {
        changeContent(1);
    });
...
function changeContent(pageNum) {
    ...
    var advFilter = {};
    advFilter['dataRange'] = selectDateRange();

    console.log(advFilter);

    $.post("/public/api/news/search-news-for-councillor", { pageNum: pageNum, pageLimit: pageLimit, sort: sort, advFilter: advFilter }, function(msg) {
